...
Pub/Sub enqueue and consume, and Redis Streams queue/stat operations. Results
...
The library exposes meaningful in-process counters and Redis Streams group
statistics. Redis Pub/Sub and Core NATS cannot report durable depth because the
