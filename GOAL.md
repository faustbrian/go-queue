...
- Redis is first-class and the primary backend
...
### 2. Redis-First Excellence

Redis should be treated as the primary production backend because it is the
most relevant backend for the immediate migration candidates.
...
### 6. Conservative First-Version Change Model
...
- integration tests for Redis-first scenarios
...
- define the Redis-first support standard
