...
const (
	deliveryAttemptHeader  = "x-go-queue-delivery-attempt"
	classificationHeader   = "x-go-queue-classification"
	failureCodeHeader      = "x-go-queue-failure-code"
	envelopeVersionHeader  = "x-go-queue-envelope-version"
	sourceQueueHeader      = "x-go-queue-source-queue"
	sourceExchangeHeader   = "x-go-queue-source-exchange"
	sourceRoutingKeyHeader = "x-go-queue-source-routing-key"
)
