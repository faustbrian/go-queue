...
func TestRedisCluster(t *testing.T) {
	t.Skip("cluster image advertises container-only node addresses to host clients")
...
func TestRedisSentinel(t *testing.T) {
	t.Skip("sentinel returns a master address that is not portable across Docker hosts")
