# Queue service lifecycle adapter technical guide
...
The module is stable at `adapters/service/v1.0.0`. Consumers may change the
import path from the released `queueservice` compatibility module without
changing its public behavior and should pin an exact released version.
