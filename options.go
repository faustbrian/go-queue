...
// WithWorkerLifecycle enables queue-owned management admission, drain, status,
// desired-state, and lifecycle command handling.
func WithWorkerLifecycle(lifecycle *management.WorkerLifecycle) Option {
	return OptionFunc(func(q *Options) {
		q.lifecycleConfigured = true
...
func NewOptions(opts ...Option) *Options {
	...
	if o.logger == nil {
		o.logger = defaultNewLogger
	}
	if o.metric == nil {
		o.metric = NewMetric()
	}
	if o.observer == nil {
		o.observer = emptyObserver{}
	}
	if o.fn == nil {
		o.fn = defaultFn
	}
